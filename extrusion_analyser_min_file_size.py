...
# user input
COM_PORT             = 'COM3'
SAMPLE_INTERVAL      = 1         # desired sample interval in milliseconds. Valid values are 1-250.
AVG_SAMPLES          = 1         # number of data points for rolling averages
        ...
        try:
            if ser.inWaiting() >= 6 :
                ...
                if good_msg or not RESEND_ON_ERROR:
                    ...
                    velocity_cmd = stepper_avg_pos / sample_interval_get * 1000 * STEPPER_MM_PER_STEP
                    velocity_act = encoder_avg_pos / sample_interval_get * 1000 * ENCODER_MM_PER_COUNT
